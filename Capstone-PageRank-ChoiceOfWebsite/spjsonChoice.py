...
conn = sqlite3.connect('spiderChoice.sqlite')
cur = conn.cursor()

print("Creating JSON output on spiderChoice.js...")
...
print("Open forceChoice.html in a browser to view the visualization")
